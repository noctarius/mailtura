import type { Static, TOmit, TSchema, TSchemaOptions } from "typebox";
import { Type } from "typebox";

export function omitDefaultProperties<
  Type extends TSchema,
  Key extends PropertyKey[],
  RetKey extends PropertyKey[] = [...Key, "id", "createdAt", "createdBy", "updatedAt", "updatedBy"],
>(type: Type, key: [...Key], options?: TSchemaOptions): TOmit<Type, RetKey> {
  return Type.Omit(type, [...key, "id", "createdAt", "createdBy", "updatedAt", "updatedBy"] as RetKey, options) as any;
}
...
export const CampaignType = Type.Union([Type.Literal("OneTime"), Type.Literal("Automated")], {
  $id: "CampaignType",
...
export const BounceType = Type.Union([Type.Literal("Hard"), Type.Literal("Soft")], {
  $id: "BounceType",
...
export const Bounce = Type.Object(
  {
    id: Type.String({ format: "uuid" }),
    contact: Contact,
...
export const SubscriberStatus = Type.Union(
...
export const Subscriber = Type.Object(
  {
    id: Type.String({ format: "uuid" }),
    contact: Contact,
...
export const SubscriberList = Type.Object(
  {
    id: Type.String({ format: "uuid" }),
    name: Type.String(),
...
export const UnsubscribeSource = Type.Union(
  [
...
export const Unsubscribe = Type.Object(
  {
    id: Type.String({ format: "uuid" }),
    contact: Contact,
...
export const EmailMetricsChartData = Type.Object({
  name: Type.String(),
  sent: Type.Integer({ minimum: 0 }),
  delivered: Type.Integer({ minimum: 0 }),
  opened: Type.Integer({ minimum: 0 }),
  ...
  additionalProperties: false,
  required: ["name", "sent", "delivered", "opened", "clicked", "bounced", "failed", "complaint", "pending", "scheduled"],
});

export type EmailMetricsChartData = Static<typeof EmailMetricsChartData>;

export const PerformanceMetricsChartData = Type.Object({
  name: Type.String(),
  deliveryRate: Type.Number({ minimum: 0, maximum: 1 }),
  openRate: Type.Number({ minimum: 0, maximum: 1 }),
  clickRate: Type.Number({ minimum: 0, maximum: 1 }),
