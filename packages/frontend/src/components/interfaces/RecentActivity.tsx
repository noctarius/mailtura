...
const RecentActivity: React.FC<RecentActivityProps> = ({ setActiveView }) => {
  const activities = [
    {
      id: 1,
      type: "success",
      ...
      <div className="space-y-4">
        {activities.map(activity => {
          ...
          return (
            ...
            >
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center ${getActivityStyles(activity.type)}`}
              >
