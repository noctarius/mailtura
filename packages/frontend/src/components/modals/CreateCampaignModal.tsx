import { Calendar, Eye, Mail, Send, Settings, Users, X } from "lucide-solid";
...
const CreateCampaignModal = (props: CreateCampaignModalProps) => {
  ...
  const handleSubmit = () => {
    props.onCreateCampaign(campaignData());
    props.onClose();
    // Reset form
    setCampaignData({
      name: "",
    ...
    switch (currentStep()) {
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    ...
                    >
                      <div class="flex items-center space-x-3">
                        ...
                        <div>
                          <h4 class="font-medium text-gray-900">One-time</h4>
                          <p class="text-sm text-gray-600">Send once to your audience</p>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      <div class="flex items-center space-x-3">
                        ...
                        <div>
                          <h4 class="font-medium text-gray-900">Automated</h4>
                          <p class="text-sm text-gray-600">Trigger-based sending</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        return (
          <div class="space-y-6">
            <div>
              ...
              <div class="space-y-4">
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-3">Select Subscriber Lists *</label>
                  <div class="space-y-3 max-h-60 overflow-y-auto border border-gray-200 rounded-lg p-4">
                    {subscriberLists.map(list => (
                      <div class="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <span class="text-sm text-gray-600">{list.count.toLocaleString()} contacts</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      case 4:
        return (
          <div class="space-y-6">
            <div>
              <h3 class="text-lg font-semibold text-gray-900 mb-4">Template & Scheduling</h3>
              <div class="space-y-6">
                <div>
                      ...
                      >
                        <div class="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">{template.preview}</p>
                          </div>
                        </div>
                      </div>
                    ))}
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-3">Scheduling</label>
                  <div class="space-y-3">
                    <div
                    ...
                    >
                      <div class="flex items-center space-x-3">
                        ...
                        <span class="font-medium text-gray-900">Send Now</span>
                      </div>
                    </div>
                    ...
                    >
                      <div class="flex items-center space-x-3">
                        ...
                        <span class="font-medium text-gray-900">Schedule for Later</span>
                      </div>
                    </div>
                    ...
                    >
                      <div class="flex items-center space-x-3">
                        ...
                        <span class="font-medium text-gray-900">Save as Draft</span>
                      </div>
                    </div>
                  </div>
          ...
          <div class="flex items-center space-x-4">
            {[1, 2, 3, 4].map(step => (
              <div class="flex items-center">
                ...
                {step < 4 && <div class={`w-12 h-1 mx-2 ${step < currentStep() ? "bg-blue-600" : "bg-gray-200"}`} />}
              </div>
            ))}
          </div>
        </div>
