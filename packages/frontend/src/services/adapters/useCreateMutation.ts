...
import { PathsWithPost, PropertyRequestParameters, RequestBody, RequestParameters, ResponseError } from "./types.js";
import { maybeHandleError } from "./errors.js";

const extractParameters = <Path extends PathsWithPost>(
...
const createOperation = async <Path extends PathsWithPost>(
...
export function useCreateMutation<Path extends PathsWithPost, InvalidationQueryKeys extends QueryKey[]>(
  url: Path,
  parameters: RequestParameters<Path>,
